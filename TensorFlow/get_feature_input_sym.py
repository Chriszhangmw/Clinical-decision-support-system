...
def GetIds(samplefilename,labelPath,tag):
    ...
    inflammation_label, Bleeding_label, obstruction_label, perforation_label, hernia_label, cancer_label = get_input_label_sym.read_label(labelPath,tag)
    if tag == 'inflammation':
        input_label = inflammation_label
    elif tag == 'Bleeding':
        input_label = Bleeding_label
    elif tag == 'obstruction':
        input_label = obstruction_label
    elif tag == 'perforation':
        input_label = perforation_label
    elif tag == 'hernia':
        input_label = hernia_label
    elif tag == 'cancer':
        input_label = cancer_label
    numWords = []
...
if __name__ == "__main__":
    ...
    samplefilename = 'data/' + tag + '/' + tag + '_after_changeorder.csv'
